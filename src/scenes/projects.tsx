      ...
      >
        <div className="w-full flex justify-center">
          <motion.button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 border-slate-100 border-2 rounded-lg hover:border-[#ff6600] transition-colors mb-10 mt-10"
                      ...
                      className={`w-12 h-12 flex items-center justify-center rounded-full cursor-pointer transition-all duration-300 
                        ${
                          activeProject === index
                            ...
                            : "bg-[#3F534E] text-slate-100 hover:bg-gray-300"
                        }`}
...
const ProjectSpotlight: React.FC<SpotlightProps> = ({ project }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex-[1_1_400px]">
        <motion.div
        ...
        >
          ...
          <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-slate-100">
            {project.title}
          </h3>
        </motion.div>

        <motion.p
          className="text-slate-100 mb-4 md:mb-6 text-sm lg:text-base"
          initial={{ opacity: 0, y: 5 }}
          animate={{ opacity: 1, y: 0 }}
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col">
        ...
        <p className="text-slate-100 text-xs sm:text-sm mb-4 line-clamp-3">
          {project.description}
        </p>
        ...
        <div className="flex flex-wrap gap-1 mb-4 mt-auto">
          {project.tags.slice(0, 3).map((tag, index) => (
            <span
              key={index}
              className="px-2 py-1 bg-slate-100 text-[#294240] text-xs font-medium rounded-full cursor-auto"
            >
              {tag}
            </span>
          ))}
